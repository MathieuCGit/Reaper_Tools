--[[
Description: MIDI Editor - force option "View: Show velocity numbers on notes" to off
Author: Mathieu CONAN   
Version: 0.1
Changelog:  initial release
Link: Github repository https://github.com/MathieuCGit/MC_VariousScripts
About: force the MIDI Editor option "View: Show velocity numbers on notes" to toggle state off
--]]


function Main()

	local Command_ID = "40632" -- View: Show velocity numbers on notes
	...
	if section_id then --if we are focused on midi editor
		--and if the "Show velocity numbers on notes" is on
